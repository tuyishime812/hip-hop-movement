        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.youtube.com/@ikk5055" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#ec4899] bg-gray-800 hover:bg-gray-700 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300">
              ...
              <a href="https://www.tiktok.com/@ikk268" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#ec4899] bg-gray-800 hover:bg-gray-700 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300">
