...
const HipHopMovementGallery: React.FC = () => {
  const [lightboxOpen, setLightboxOpen] = useState<boolean>(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number>(0);
  
  // Hip-Hop movement images
  const hiphopMovementImages = [
    {
      id: 1,
  ...
  const goToNextImage = () => {
    const nextIndex = (currentImageIndex + 1) % hiphopMovementImages.length;
    setCurrentImageIndex(nextIndex);
  };

  // Navigate to previous image in lightbox
  const goToPrevImage = () => {
    const prevIndex = (currentImageIndex - 1 + hiphopMovementImages.length) % hiphopMovementImages.length;
  ...
  }, [lightboxOpen, currentImageIndex, hiphopMovementImages.length]);

  return (
    <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 dark:text-slate-100">Hip-Hop Movement</h2>
          <h3 className="text-xl md:text-2xl font-semibold mb-4 text-[#3b82f6] dark:text-[#93c5fd]">From the Streets to the Future</h3>
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-slate-300 max-w-3xl mx-auto">
            Our foundation celebrates the rich culture and heritage of hip-hop, while building bridges to the future.
            These images showcase the impact of the hip-hop movement in our community.
          </p>
        </div>
        ...
        {/* Single Hip-Hop Movement Image Preview */}
        <div className="max-w-4xl mx-auto mb-12">
          <div
            ...
            onClick={() => openLightbox(0)} // Show hiphop as the main preview
          >
            <div className="relative h-96 overflow-hidden">
              <Image
                src={hiphopMovementImages[0].src}
                alt={hiphopMovementImages[0].alt}
                fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <p className="text-white text-lg font-medium">{hiphopMovementImages[0].caption}</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-6">
            ...
            >
              View All Hip-Hop Movement Activities
            </button>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="relative w-full h-[70vh]">
                <Image
                  src={hiphopMovementImages[currentImageIndex].src}
                  alt={hiphopMovementImages[currentImageIndex].alt}
                  fill
              ...
              <div className="mt-4 text-white text-center">
                <h3 className="text-xl font-bold">{hiphopMovementImages[currentImageIndex].caption}</h3>
                <p className="text-gray-300 mt-2">
                  {currentImageIndex + 1} of {hiphopMovementImages.length}
                </p>
                <div className="mt-6">
...
export default HipHopMovementGallery;