...
const LeadersSlider: React.FC = () => {
  ...
  }, [isAutoPlaying, leaders.length, loading]);
  ...
  if (loading) {
    return (
      <div className="relative w-full max-w-6xl mx-auto py-12 flex justify-center items-center h-[500px]">
