...
const ArtsSupportGallery: React.FC = () => {
  const [lightboxOpen, setLightboxOpen] = useState<boolean>(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number>(0);
  
  // Arts support images
  const artsSupportImages = [
    {
      id: 1,
      src: '/images/arts_support.jpg',
      alt: 'Arts Support',
      caption: 'Supporting arts and creative expression in the community'
    },
    {
      id: 2,
  ...
  const goToNextImage = () => {
    const nextIndex = (currentImageIndex + 1) % artsSupportImages.length;
    setCurrentImageIndex(nextIndex);
  };

  // Navigate to previous image in lightbox
  const goToPrevImage = () => {
    const prevIndex = (currentImageIndex - 1 + artsSupportImages.length) % artsSupportImages.length;
  ...
  }, [lightboxOpen, currentImageIndex, artsSupportImages.length]);

  return (
    <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 dark:text-slate-100">Arts Support</h2>
          <h3 className="text-xl md:text-2xl font-semibold mb-4 text-[#3b82f6] dark:text-[#93c5fd]">Nurturing Creative Expression</h3>
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-slate-300 max-w-3xl mx-auto">
            Our foundation is committed to supporting artistic expression across all forms of creativity.
            These images showcase our efforts to empower artists and creators in the community.
          </p>
        </div>
        ...
        {/* Single Arts Support Image Preview */}
        <div className="max-w-4xl mx-auto mb-12">
          <div
            ...
            onClick={() => openLightbox(0)} // Show arts_support as the main preview
          >
            <div className="relative h-96 overflow-hidden">
              <Image
                src={artsSupportImages[0].src}
                alt={artsSupportImages[0].alt}
                fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <p className="text-white text-lg font-medium">{artsSupportImages[0].caption}</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-6">
            ...
            >
              View All Arts Support Activities
            </button>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <Link href="#donate" className="inline-block hiphop-btn hiphop-btn-primary px-8 py-4 text-lg">
            Support Creative Expression Today
          </Link>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="relative w-full h-[70vh]">
                <Image
                  src={artsSupportImages[currentImageIndex].src}
                  alt={artsSupportImages[currentImageIndex].alt}
                  fill
              ...
              <div className="mt-4 text-white text-center">
                <h3 className="text-xl font-bold">{artsSupportImages[currentImageIndex].caption}</h3>
                <p className="text-gray-300 mt-2">
                  {currentImageIndex + 1} of {artsSupportImages.length}
                </p>
                <div className="mt-6">
...
export default ArtsSupportGallery;