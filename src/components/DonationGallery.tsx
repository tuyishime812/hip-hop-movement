...
const DonationGallery: React.FC = () => {
  ...
  const donationImages = [
    {
      ...
      alt: 'Donation Event',
      caption: 'Hip-Hop Movement donation to elders and vulnerable women in Blantyre'
    },
    {
      id: 2,
      src: '/images/donation1.jpeg',
      alt: 'Donation Drive',
      caption: 'Supporting the community through hip-hop inspired donation drives'
    },
    {
      id: 3,
      src: '/images/donation2.jpeg',
      alt: 'Donation Distribution',
      caption: 'Distributing donations to elders and vulnerable women in Blantyre'
    },
    {
      id: 4,
      src: '/images/donation3.jpeg',
      alt: 'Donation Collection',
      caption: 'Collecting donations for community support initiatives'
    },
    {
      id: 5,
  ...
  const goToNextImage = () => {
    const nextIndex = (currentImageIndex + 1) % donationImages.length;
    setCurrentImageIndex(nextIndex);
  };

  // Navigate to previous image in lightbox
  const goToPrevImage = () => {
    const prevIndex = (currentImageIndex - 1 + donationImages.length) % donationImages.length;
  ...
  }, [lightboxOpen, currentImageIndex, donationImages.length]);

  return (
    <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 dark:text-slate-100">Hip-Hop Movement Donation</h2>
          <h3 className="text-xl md:text-2xl font-semibold mb-4 text-[#3b82f6] dark:text-[#93c5fd]">Supporting Elders and Vulnerable Women in Blantyre</h3>
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-slate-300 max-w-3xl mx-auto">
            Our foundation is committed to supporting elders and vulnerable women in Blantyre through various donation initiatives.
            These images showcase our ongoing efforts to make a positive impact in the community.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div
            ...
            onClick={() => openLightbox(5)} // Show with_elder_people as the main preview
          >
            <div className="relative h-96 overflow-hidden">
              <Image
                src={donationImages[5].src}
                alt={donationImages[5].alt}
                fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <p className="text-white text-lg font-medium">{donationImages[5].caption}</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="relative w-full h-[70vh]">
                <Image
                  src={donationImages[currentImageIndex].src}
                  alt={donationImages[currentImageIndex].alt}
                  fill
              ...
              <div className="mt-4 text-white text-center">
                <h3 className="text-xl font-bold">{donationImages[currentImageIndex].caption}</h3>
                <p className="text-gray-300 mt-2">
                  {currentImageIndex + 1} of {donationImages.length}
                </p>
                <div className="mt-6">
